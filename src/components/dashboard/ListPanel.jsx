...
import { Modal, ModalOverlay, ModalContent, ModalHeader, ModalCloseButton, ModalBody, ModalFooter, Button, Input, useDisclosure, useMediaQuery } from '@chakra-ui/react';
...
const ListPanel = () => {
  ...
  return (
    <Box className='panel-style' overflowY="auto" minH="100vh" sx={{
      '&::-webkit-scrollbar': {
        width: '10px',
      },
      ...
      <div style={{ height: "100%", width: "100%", maxHeight:"calc(100vh - 150px)", overflowY:"auto" }}>
